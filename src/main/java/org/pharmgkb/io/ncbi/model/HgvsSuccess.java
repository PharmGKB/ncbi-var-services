...
import org.pharmgkb.io.ncbi.model.Hgvs;

/**
 * Successful response to a request for a single HGVS object
 */
@Schema(description = "Successful response to a request for a single HGVS object")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-25T10:32:24.325-07:00[America/Los_Angeles]")public class HgvsSuccess {

  @SerializedName("data")
  private Hgvs data = null;
  public HgvsSuccess data(Hgvs data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HgvsSuccess hgvsSuccess = (HgvsSuccess) o;
    return Objects.equals(this.data, hgvsSuccess.data);
  }

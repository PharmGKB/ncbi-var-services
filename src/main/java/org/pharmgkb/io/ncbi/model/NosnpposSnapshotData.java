 ...
 */
@Schema(description = "Data specific to nosnppos snapshots")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-04-25T10:32:24.325-07:00[America/Los_Angeles]")public class NosnpposSnapshotData {

  @SerializedName("support")
  private List<Support> support = new ArrayList<Support>();
  public NosnpposSnapshotData support(List<Support> support) {
    this.support = support;
    return this;
  }

  public NosnpposSnapshotData addSupportItem(Support supportItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NosnpposSnapshotData nosnpposSnapshotData = (NosnpposSnapshotData) o;
    return Objects.equals(this.support, nosnpposSnapshotData.support);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(support);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NosnpposSnapshotData {\n");
